...
document.querySelector("#submit-btn").addEventListener("click", () => {
    ...
    if (movie == "") {
        alert("Please type a movie title");
          ...
          // fetch(`https://cdnjs.cloudflare.com/ajax/libs/babel-standalone/6.26.0/babel.min.js" integrity="sha512-kp7YHLxuJDJcOzStgd6vtpxr4ZU9kjn77e6dBsivSz+pUuAuMlE2UTdKB7jjsWT84qbS8kdCWHPETnP/ctrFsA==" crossorigin="anonymous" referrerpolicy="no-referrer`)
              .then(res => {
                  return res.json()
              }).then(data => {
